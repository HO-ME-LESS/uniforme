...
<div class="container" style="margin-top:65px">
    ...
    <hr/>
    <!--menu list-->
    <div class="row text-center" id="blouse">
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/polo1.jpg" alt="" class="img-fluid pb-1" >
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/polo2.jpg" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Polo Dirty White</h6>
                    <h6>Price : 200PHP</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/polo3.jpg" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Polo Blue</h6>
                    <h6>Price : 200PHP</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/polo4.jpg" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Polo Green</h6>
                    <h6>Price : 200PHP</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
    ...
    <div class="row text-center" id="blouse">
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                    <img src="images/blouse1.jpg" alt="" class="img-fluid pb-1"  >
                    <div class="figure-caption">
                    <h6>Blouse White</h6>
                    <h6>Price : 100PHP</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                    <img src="images/blouse2.jpg" alt="" class="img-fluid pb-1" >
                    <div class="figure-caption">
                    <h6>Blouse Dirty White</h6>
                    <h6>Price : 100PHP</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                    <img src="images/blouse3.jpg" alt="" class="img-fluid pb-1">
                    <div class="figure-caption">
                        <h6>Blouse Blue</h6>
                        <h6>Price : 100PHP</h6>
                        <?php if (!isset($_SESSION['email'])) {?>
            ...
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                    <img src="images/blouse4.jpg" alt="" class="img-fluid pb-1">
                    <div class="figure-caption">
                        <h6>Blouse Green</h6>
                        <h6>Price : 100PHP</h6>
                        <?php if (!isset($_SESSION['email'])) {?>
        ...
        <div class="row text-center" id="pants" >
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/pants1.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h6>Pants Black</h6>
                            <h6>Price : 300PHP</h6>
                            <?php if (!isset($_SESSION['email'])) {?>
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/pants2.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h6>Pants Brown</h6>
                            <h6>Price : 300PHP</h6>
                            <?php if (!isset($_SESSION['email'])) {?>
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/pants3.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h6>Pants Blue</h6>
                            <h6>Price : 300PHP</h6>
                            <?php if (!isset($_SESSION['email'])) {?>
                ...
                <div class="col-md-3 col-6 py-3" >
                    <div class="card">
                        <img src="images/pants4.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                        <h6>Pants Green</h6>
                    <h6>Price : 300PHP</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
            ...
            <div class="row text-center" id="psau uniform">
                    <div class="col-md-3 col-6 py-3" >
                        <div class="card">
                            <img src="images/psaupolo1.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>PSAU Polo</h6>
                                <h6>Price : 400PHP</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/psaupants1.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>PSAU pants</h6>
                                <h6>Price : 200PHP</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/psaublouse1.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>PSAU Blouse</h6>
                                <h6>Price : 400PHP</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                   ...
                   <?php
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/psauskirt1.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>PSAU Skirt</h6>
                                <h6>Price : 200PHP</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
