...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'Delius Swash Caps'">UNIFORME'</a>
                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php#polo" class="dropdown-item">Polo</a>
                                   <a href="products.php#blouse" class="dropdown-item">Blouse</a>
                                   <a href="products.php#pants" class="dropdown-item">Pants</a>
                                   <a href="products.php#skirt" class="dropdown-item">Skirt</a>
                               </div>
